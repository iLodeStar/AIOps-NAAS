...
graph TD
    ...
    H1 --> H2[Raw Data Correlation<br/>- Weather + Satellite<br/>- System + Network<br/>- Location + Performance]
...
- **Input**: Raw metrics, logs, telemetry from storage systems
- **Output**: Enriched and correlated data streams with maritime context
...
graph TD
    ...
    J1 --> J3[Context-Aware Detection<br/>- Weather-adjusted thresholds<br/>- System load correlation<br/>- Maritime operations context]
...
graph TD
    ...
    %% Correlation logic
    L1 --> L2[Anomaly Correlation Engine<br/>- Time window grouping<br/>- Causal relationship detection<br/>- Maritime scenario correlation]
...
graph TD
    ...
    S1 --> S2[Maritime Playbook Engine<br/>- OPA policy evaluation<br/>- Automated remediation<br/>- Human approval workflows]
...
graph TD
    ...
    W1 --> W4[Predictive Analytics<br/>- Capacity planning<br/>- Performance forecasting<br/>- Resource optimization]
    W2 --> W5[Fleet Intelligence<br/>- Cross-ship comparison<br/>- Best practice sharing<br/>- Performance benchmarking]
